      ...
      <div className="flex justify-between py-4 items-center relative z-100 bg-transparent">
        ...
        <div className="hidden lg:flex justify-between gap-8 xl:gap-20 items-center">
          <div className="flex gap-4 xl:gap-5 items-center">
            <Link
              href="/"
              className="text-sm xl:text-base hover:text-[#248A3A] transition-colors"
            >
              Home
            </Link>
            <Link
            ...
            <a
              href="#experts"
              onClick={(e) => handleSectionNav(e, "experts")}
              className="text-sm xl:text-base hover:text-[#248A3A] transition-colors cursor-pointer"
            >
              Experts
            </a>
            <a
              href="#reviews"
              onClick={(e) => handleSectionNav(e, "reviews")}
              className="text-sm xl:text-base hover:text-[#248A3A] transition-colors cursor-pointer"
            >
              Reviews
            </a>
        ...
        <div className="pt-17 px-2">
          <nav className="space-y-1">
            ...
            <Link
              ...
              className="block py-3 px-4 text-black text-lg font-normal"
            >
              Home
            </Link>
